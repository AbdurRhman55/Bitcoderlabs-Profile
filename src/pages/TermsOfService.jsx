    ...
    const sections = [
        {
            ...
            content: 'By accessing or using the Bitcoderlabs website and services, you agree to be bound by these Terms of Service. If you do not agree, please do not use our platform.'
        },
        {
            id: 'responsibilities',
            title: '2. USER RESPONSIBILITIES',
            content: 'Users are responsible for maintaining the confidentiality of any account information and for all activities that occur under their account. You agree to use our services only for lawful purposes.'
        },
        {
            id: 'ip',
            title: '3. INTELLECTUAL PROPERTY',
            content: 'All content, features, and functionality on the Bitcoderlabs website, including text, graphics, logos, and software, are the exclusive property of Bitcoderlabs and are protected by international copyright laws.'
        },
        {
            id: 'liability',
            title: '4. LIMITATION OF LIABILITY',
            content: 'Bitcoderlabs shall not be liable for any indirect, incidental, special, or consequential damages resulting from the use or the inability to use our services.'
        },
        {
            id: 'law',
        ...
        },
        {
            ...
            content: 'We reserve the right to modify or replace these Terms of Service at any time. Your continued use of the site following any changes constitutes acceptance of the new terms.'
        }
    ];
                ...
                <header className="text-center mb-12">
                    ...
                    <div className="bg-[#cc2121] text-white p-6 md:p-10 rounded-xl mb-12 md:mb-20 shadow-lg max-w-4xl mx-auto">
                        <p className="text-base md:text-xl font-medium leading-relaxed">
                            These Terms of Service govern your use of the Bitcoderlabs platform and services.
                        </p>
                    </div>
                </header>
                ...
                <div className="flex flex-col lg:flex-row gap-16 items-start relative">
                    ...
                    <div className="flex-1 w-full overflow-hidden">
                        <div className="space-y-12">
                            <section>
                                <h2 className="text-2xl md:text-4xl font-black text-gray-900 mb-6 font-sans">Usage Agreement</h2>
                                <p className="text-base md:text-lg text-gray-600 leading-relaxed mb-6 font-medium">
                                    By accessing or using the Services provided by <strong>Bitcoderlabs Inc.</strong>, you agree to comply with and be bound by the following terms. Please read them carefully.
                                </p>
                            </section>
